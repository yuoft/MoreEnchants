...
public class DiamondAnvil extends FallingBlock {
    ...
    public static BlockState damage(BlockState state) {
        if (state.matchesBlock(BlockRegistry.diamondAnvil.get())) {
            return BlockRegistry.chippedDiamondAnvil.get().getDefaultState().with(FACING, state.get(FACING));
        } else {
            return state.matchesBlock(BlockRegistry.chippedDiamondAnvil.get()) ? BlockRegistry.damagedDiamondAnvil.get().getDefaultState().with(FACING, state.get(FACING)) : null;
        }
    }
