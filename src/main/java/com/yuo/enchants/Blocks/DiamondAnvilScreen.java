...
@OnlyIn(Dist.CLIENT)
public class DiamondAnvilScreen extends AbstractRepairScreen<DiamondRepairContainer> {
    ...
    public DiamondAnvilScreen(DiamondRepairContainer container, PlayerInventory playerInventory, ITextComponent title) {
