...
public class ExpDrip extends Item {
    ...
    public void appendHoverText(ItemStack pStack, @org.jetbrains.annotations.Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        ...
        if (item == YEItems.smallExpDrip.get()){
            pTooltipComponents.add(Component.translatable("yuoenchants.text.itemInfo.small_exp_drip"));
        }
        if (item == YEItems.bigExpDrip.get()){
            pTooltipComponents.add(Component.translatable("yuoenchants.text.itemInfo.big_exp_drip"));
        }
    }
