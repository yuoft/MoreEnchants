...
public class OreBiomeModifiers {
    ...
    public static final ResourceKey<BiomeModifier> ADD_IRON_NETHER_ORE = registerKey("add_iron_nether_ore");
    public static final ResourceKey<BiomeModifier> ADD_GOLD_ORE = registerKey("add_gold_ore");
    public static final ResourceKey<BiomeModifier> ADD_GOLD_NETHER_ORE = registerKey("add_gold_nether_ore");
    ...
    public static void bootstrap(BootstapContext<BiomeModifier> context) {
        ...
        context.register(ADD_IRON_ORE, new AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures.getOrThrow(OrePlacements.ORE_IRON)),
                GenerationStep.Decoration.UNDERGROUND_ORES));
        context.register(ADD_IRON_NETHER_ORE, new AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures.getOrThrow(OrePlacements.ORE_IRON_NETHER)),
                GenerationStep.Decoration.UNDERGROUND_ORES));
        context.register(ADD_GOLD_ORE, new AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures.getOrThrow(OrePlacements.ORE_GOLD)),
                GenerationStep.Decoration.UNDERGROUND_ORES));
        context.register(ADD_GOLD_NETHER_ORE, new AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
    ...
    private static ResourceKey<BiomeModifier> registerKey(String name) {
        return ResourceKey.create(ForgeRegistries.Keys.BIOME_MODIFIERS, new ResourceLocation(YuoEnchants.MOD_ID, name));
    }
}
