...
public class DiamondAnvilMenu extends ItemCombinerMenu {
    ...
    public void createResult() {
        ...
        if (itemstack.isEmpty()) {
            ...
            if (StringUtils.isBlank(this.itemName)) {
                ...
                k = 1;
                i += k;
                itemstack1.setHoverName(Component.keybind(this.itemName));
            }
    ...
    protected ItemCombinerMenuSlotDefinition createInputSlotDefinitions() {
        return ItemCombinerMenuSlotDefinition.create().withSlot(0, 27, 47,
                (e) -> true).withSlot(1, 76, 47,
                (e) -> true).withResultSlot(2, 134, 47).build();
    }
    ...
    public void setItemName(String newName) {
        ...
        if (this.getSlot(2).hasItem()) {
            ...
            if (StringUtils.isBlank(newName)) {
                ...
                itemstack.setHoverName(Component.keybind(this.itemName));
            }
        }
